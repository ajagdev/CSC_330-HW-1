...
val june2_2013 = {year = 2013, month = 6, day = 2}
...
val test1d = is_older(dec1_2013, june1_2013) = true;
...
val test2c = number_in_month([feb28_2012,dec1_2013,march31_2011,april28_2011,june1_2013,june2_2013],6) = 2
...
val test3c = number_in_months([feb28_2012,dec1_2013,march31_2011,april28_2011,june1_2013,june2_2013],[2,3,4,6]) = 5
...
val test4c = dates_in_month([feb28_2012,dec1_2013,june1_2013,june2_2013],6) = [june1_2013,june2_2013]
...
val test5c = dates_in_months([feb28_2012,dec1_2013,june1_2013,june2_2013],[2,3,6,12]) =[feb28_2012,june1_2013,june2_2013,dec1_2013]
...
val test8d = number_before_reaching_sum(1, [0,2,3,4,5]) = 1;
val test8e = number_before_reaching_sum(3, [0,2,3,4,5]) = 2;

val test9  = what_month(70) = 3
val test9a = what_month(31) = 1
val test9b = what_month(32) = 2
val test9c = what_month(360) = 12
val test9d = what_month(42) = 2
...
val test10f = month_range(31+31, 31+29) = []
...
val test11c = oldest([june2_2013,june1_2013]) = SOME june2_2013
...
val test12e = not (reasonable_date{year = 0, month = 0, day = 31});
